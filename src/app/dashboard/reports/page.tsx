    ...
    <div className="max-w-6xl mx-auto pb-12">
      ...
      <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-2 border border-gray-200 text-gray-600 px-3 py-2 rounded-lg text-xs font-medium hover:bg-gray-50 transition-colors"
          >
            <Download size={13} />
            Invoices CSV
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard
          ...
          color={summary.netProfit >= 0 ? "bg-blue-50 text-blue-600" : "bg-red-50 text-red-600"}
          ...
          {agingData.every((a) => a.amount === 0) ? (
            ...
            <div className="space-y-3">
              {agingData.map((bucket, i) => {
                const total = agingData.reduce((s, a) => s + a.amount, 0);
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400">{data.invoices.length} invoices</span>
        </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {data.invoices.slice(0, 10).map((inv) => (
                  <tr key={inv.number} className="border-b border-gray-100 last:border-0 hover:bg-gray-50">
                    <td className="px-5 py-3 font-mono text-xs text-gray-600">{inv.number}</td>
                    <td className="px-5 py-3 text-gray-900 font-medium">{inv.client}</td>
